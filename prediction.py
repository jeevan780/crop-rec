...
# Load dataset
csv_path = r"Crop-Recommendation-System-Using-Machine-Learning\Crop_recommendation_with_price_data1.csv"  # Replace with your dataset path
...
with open(r"Crop-Recommendation-System-Using-Machine-Learning\Crop_Recommendation_Model.pkl", 'wb') as model_file:
    pickle.dump(rfc, model_file)

with open(r"Crop-Recommendation-System-Using-Machine-Learning\crop_scaler.pkl", 'wb') as scaler_file:
